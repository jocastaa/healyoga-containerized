...
class ApiService {
  ...
  Future<Map<String, dynamic>> register({
    ...
    return await _post('/auth/register', {
      ...
      if (preferredSessionLength != null)
  ...
  Future<Map<String, dynamic>> getNotificationSettings(String userId) async {
    return await _get('/notifications/$userId');
  }
  ...
  Future<void> scheduleDailyReminder({
    ...
    await _post('/notifications/schedule', {
      'userId': userId,
      'hour': hour,
      'minute': minute,
    });
  ...
  Future<void> cancelDailyReminder(String userId) async {
    await http
        .delete(
      Uri.parse('$_baseUrl/notifications/cancel/$userId'),
      headers: _headers,
    )
        .timeout(const Duration(seconds: 60));
  }
  ...
  Future<void> sendNotificationNow({
    ...
    await _post('/notifications/send', {
      'userId': userId,
      'title': title,
      'body': body,
    });
  ...
  Future<List<dynamic>> getNotificationLogs(String userId) async {
